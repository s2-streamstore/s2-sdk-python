...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ACCOUNTSERVICE'].methods_by_name['ListBasins']._serialized_options = b'\220\002\001'
  _globals['_ACCOUNTSERVICE'].methods_by_name['CreateBasin']._loaded_options = None
  _globals['_ACCOUNTSERVICE'].methods_by_name['CreateBasin']._serialized_options = b'\220\002\002'
  _globals['_ACCOUNTSERVICE'].methods_by_name['DeleteBasin']._loaded_options = None
  _globals['_ACCOUNTSERVICE'].methods_by_name['DeleteBasin']._serialized_options = b'\220\002\002'
  _globals['_ACCOUNTSERVICE'].methods_by_name['ReconfigureBasin']._loaded_options = None
  _globals['_ACCOUNTSERVICE'].methods_by_name['ReconfigureBasin']._serialized_options = b'\220\002\002'
  _globals['_ACCOUNTSERVICE'].methods_by_name['GetBasinConfig']._loaded_options = None
  _globals['_ACCOUNTSERVICE'].methods_by_name['GetBasinConfig']._serialized_options = b'\220\002\001'
  _globals['_BASINSERVICE'].methods_by_name['ListStreams']._loaded_options = None
  _globals['_BASINSERVICE'].methods_by_name['ListStreams']._serialized_options = b'\220\002\001'
  _globals['_BASINSERVICE'].methods_by_name['CreateStream']._loaded_options = None
  _globals['_BASINSERVICE'].methods_by_name['CreateStream']._serialized_options = b'\220\002\002'
  _globals['_BASINSERVICE'].methods_by_name['DeleteStream']._loaded_options = None
  _globals['_BASINSERVICE'].methods_by_name['DeleteStream']._serialized_options = b'\220\002\002'
  _globals['_BASINSERVICE'].methods_by_name['GetStreamConfig']._loaded_options = None
  _globals['_BASINSERVICE'].methods_by_name['GetStreamConfig']._serialized_options = b'\220\002\001'
  _globals['_BASINSERVICE'].methods_by_name['ReconfigureStream']._loaded_options = None
  _globals['_BASINSERVICE'].methods_by_name['ReconfigureStream']._serialized_options = b'\220\002\002'
  _globals['_STREAMSERVICE'].methods_by_name['CheckTail']._loaded_options = None
  _globals['_STREAMSERVICE'].methods_by_name['CheckTail']._serialized_options = b'\220\002\001'
  _globals['_STREAMSERVICE'].methods_by_name['Read']._loaded_options = None
  _globals['_STREAMSERVICE'].methods_by_name['Read']._serialized_options = b'\220\002\001'
  _globals['_STREAMSERVICE'].methods_by_name['ReadSession']._loaded_options = None
  _globals['_STREAMSERVICE'].methods_by_name['ReadSession']._serialized_options = b'\220\002\001'
