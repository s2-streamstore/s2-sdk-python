...
def add_AccountServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('s2.v1alpha.AccountService', rpc_method_handlers)
...
def add_BasinServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('s2.v1alpha.BasinService', rpc_method_handlers)
...
def add_StreamServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('s2.v1alpha.StreamService', rpc_method_handlers)
